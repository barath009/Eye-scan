...
import AnalysisResults from "./AnalysisResults"; // ⬅ Import results component
...
const CameraInterface = () => {
  ...
  const classifyRisk = (blinkRate: number) => {
    ...
    if (blinkRate >= 10 && blinkRate <= 16) return "normal";
    if (blinkRate > 16) return "stress";
    return "uncertain";
  };
      ...
      faceMesh.onResults((results: any) => {
        ...
        if (results.multiFaceLandmarks.length > 0) {
          ...
          if (ear < BLINK_THRESHOLD) {
            ...
            if (blinkFrameCounterRef.current >= BLINK_CONSEC_FRAMES) {
          ...
          <div className="mt-6 p-4 rounded-lg bg-blue-50">
            ...
            <div className="flex justify-around bg-blue-100 rounded-lg p-4">
              ...
              <div className="text-center">
                ...
                <p className="text-green-600 font-semibold">10–16/min</p>
                <p>Normal</p>
              </div>
              <div className="text-center">
                <div className="w-4 h-4 bg-yellow-500 rounded-full mx-auto mb-1"></div>
                <p className="text-yellow-600 font-semibold">&gt;16/min</p>
